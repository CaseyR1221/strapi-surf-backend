...
export interface ApiInfoblockHomeInfoblockHome extends Schema.SingleType {
  collectionName: 'infoblock_homes';
  info: {
    singularName: 'infoblock-home';
    pluralName: 'infoblock-homes';
    displayName: 'infoblock home';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    info_blocks: Attribute.Relation<
      'api::infoblock-home.infoblock-home',
      'oneToMany',
      'api::info-block.info-block'
    >;
    createdAt: Attribute.DateTime;
